...
export default function FormLeavePage({ employeeId }: Props) {
    ...
    // Shared Styles based on your Template
            ...
            <div className="space-y-6">
                ...
                <div className="flex justify-end pt-2">
                    <button
                        ...
                        className="bg-gray-900 text-white dark:bg-zinc-100 dark:text-zinc-900 text-xs font-bold uppercase tracking-wider px-5 py-2.5 rounded-lg hover:bg-gray-800 dark:hover:bg-zinc-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                    >
                        + Add to Application
                    </button>
                </div>
