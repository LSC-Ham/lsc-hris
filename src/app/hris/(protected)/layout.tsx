...
export default async function ProtectedLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        // Main wrapper using slate-50 for light mode and zinc-950 for deep dark mode
        <div className="flex min-h-screen bg-slate-50 dark:bg-zinc-950 transition-colors duration-300">
            ...
            <div className="flex-1 flex flex-col">
                {/* Header matching the Sidebar's white/zinc-900 surface */}
                ...
                {/* Added pt-16 on mobile to account for the mobile fixed header inside Sidebar */}
