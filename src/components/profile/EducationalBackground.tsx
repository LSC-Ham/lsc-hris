            ...
            {isFormOpen ? (
                <div className="space-y-6 p-6 border border-gray-200 rounded-xl shadow-sm">
                    <div className="flex justify-between items-center mb-4">
                        <h2 className="text-sm font-bold text-gray-900 dark:text-zinc-100 tracking-tight">
                ...
                <div className="space-y-4">
                    {formData.length === 0 ? (
                        <div className="p-10 text-center border-2 border-dashed border-gray-200 dark:border-zinc-800 rounded-xl bg-gray-50/50 dark:bg-zinc-900/30 text-gray-500 dark:text-zinc-400 transition-all">
                            <div className="flex flex-col items-center gap-1">
                                <p className="text-sm font-medium text-gray-600 dark:text-zinc-300">
                                    No educational background added yet.
                                </p>
                                <p className="text-xs">
                                    Click <span className="text-brand dark:text-green-500 font-semibold uppercase tracking-wide">"Add New Record"</span> to begin.
                                </p>
                            </div>
                        </div>
                    ) : (
