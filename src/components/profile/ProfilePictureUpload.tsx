...
import { uploadProfilePicture } from '@/actions/employees/post';
import { deleteProfilePicture } from '@/actions/employees/delete';
...
export default function ProfilePictureUpload({ userId, initialImage }: ProfilePictureProps) {
    ...
    // ✨ NEW: State to control the Options Menu and a ref for the hidden file input
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            {/* 1. CLICKABLE AVATAR (Now opens the Options Menu) */}
            <button
                ...
                >
                    ...
                    >
                        <div className="p-4 border-b border-gray-100 bg-gray-50">
                            <h3 className="text-sm font-bold text-center text-gray-500 uppercase tracking-wider">Profile Photo</h3>
                        </div>
